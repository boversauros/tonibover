...
6. `/src/pages/reflexions/[...page].astro`
7. `/src/pages/reflexions/[category]/[...page].astro`
8. `/src/pages/reflexions/paraula-clau/[keyword]/[...page].astro`
9. `/src/pages/reflexions/[...slug].astro`

**Low Priority (might use layouts):**
10. `/src/pages/preambul/20.astro`
11. `/src/pages/preambul/40.astro`
12. `/src/pages/preambul/60.astro`
